...
export const ApplicationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createApplication: async (organisation: string, application: Application, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications`
        ...
        deleteApplication: async (organisation: string, application: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
        ...
        getEcrLoginCredentials: async (organisation: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/ecr-login`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const BackupManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createBackup: async (organisation: string, application: string, environment: string, type: CreateBackupTypeEnum, createBackupRequest?: CreateBackupRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/backups/{type}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
        ...
        deleteBackup: async (organisation: string, application: string, environment: string, type: DeleteBackupTypeEnum, backupId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/backups/{type}/{backupId}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
                .replace(`{${"type"}}`, encodeURIComponent(String(type)))
        ...
        downloadBackup: async (organisation: string, application: string, environment: string, type: DownloadBackupTypeEnum, backupId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/backups/{type}/{backupId}/download`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
                .replace(`{${"type"}}`, encodeURIComponent(String(type)))
...
export const CommandsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createCommand: async (organisation: string, environment: string, createCommandRequest: CreateCommandRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/environments/{environment}/commands`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
        ...
        getCommand: async (organisation: string, environment: string, command: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/environments/{environment}/commands/{command}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
...
export const ComposeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getEnvironmentCompose: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/environments/{environment}/compose`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        validateCompose: async (organisation: string, validateComposeRequest: ValidateComposeRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/compose/validate`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ContainersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        listContainers: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/containers`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        updateContainer: async (organisation: string, application: string, environment: string, container: string, container2: Container, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/containers/{container}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
...
export const CronApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createCronJob: async (organisation: string, application: string, environment: string, createCronJobRequest: CreateCronJobRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/cron`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        deleteCronJob: async (organisation: string, application: string, environment: string, cron: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/cron/{cron}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
        ...
        getCronRun: async (organisation: string, application: string, environment: string, cron: string, run: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/cron/{cron}/runs/{run}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
                .replace(`{${"cron"}}`, encodeURIComponent(String(cron)))
        ...
        listCronJobRuns: async (organisation: string, application: string, environment: string, cron: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/cron/{cron}/runs`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
                .replace(`{${"cron"}}`, encodeURIComponent(String(cron)));
...
export const EnvironmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createEnvironment: async (organisation: string, application: string, createEnvironmentRequest: CreateEnvironmentRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
        ...
        deleteEnvironment: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        getEnvironmentLogs: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organisation' is not null or undefined
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/logs`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        getEnvironmentMetrics: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organisation' is not null or undefined
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/metrics`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        listSyncOperations: async (organisation: string, application: string, environment: string, type: ListSyncOperationsTypeEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/sync/{type}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
                .replace(`{${"type"}}`, encodeURIComponent(String(type)));
        ...
        updateEnvironmentState: async (organisation: string, application: string, environment: string, updateEnvironmentStateRequest: UpdateEnvironmentStateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/state`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const EnvironmentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getEnvironmentLogs(organisation: string, application: string, environment: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEnvironmentLogs(organisation, application, environment, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getEnvironmentMetrics(organisation: string, application: string, environment: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEnvironmentMetrics(organisation, application, environment, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const EnvironmentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getEnvironmentLogs(organisation: string, application: string, environment: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getEnvironmentLogs(organisation, application, environment, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get the metrics for an environment
         ...
         * @throws {RequiredError}
         */
        getEnvironmentMetrics(organisation: string, application: string, environment: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getEnvironmentMetrics(organisation, application, environment, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all environments for an application
...
export class EnvironmentsApi extends BaseAPI {
     ...
     * @memberof EnvironmentsApi
     */
    public getEnvironmentLogs(organisation: string, application: string, environment: string, options?: RawAxiosRequestConfig) {
        return EnvironmentsApiFp(this.configuration).getEnvironmentLogs(organisation, application, environment, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EnvironmentsApi
     */
    public getEnvironmentMetrics(organisation: string, application: string, environment: string, options?: RawAxiosRequestConfig) {
        return EnvironmentsApiFp(this.configuration).getEnvironmentMetrics(organisation, application, environment, options).then((request) => request(this.axios, this.basePath));
    }
...
export const PurgeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Purge cache keys from a project
         * @param {string} organization 
         * @param {string} project 
...
/**
 * RulesAuthApi - axios parameter creator
 * @export
 */
export const RulesAuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesAuthApi - functional programming interface
 * @export
 */
export const RulesAuthApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesAuthApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create an authentication rule
        ...
        async rulesAuthCreate(organization: string, project: string, v2RuleAuthRequest: V2RuleAuthRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleAuth>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesAuthApi.rulesAuthCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesAuthDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesAuthApi.rulesAuthDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesAuthList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleAuth>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesAuthApi.rulesAuthList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesAuthRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleAuth>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesAuthApi.rulesAuthRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesAuthUpdate(organization: string, project: string, rule: string, v2RuleAuthRequest: V2RuleAuthRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleAuth>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesAuthApi.rulesAuthUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesAuthApi - factory interface
 * @export
 */
export const RulesAuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesAuthApiFp(configuration)
    return {
        /**
         * 
         * @summary Create an authentication rule
...
/**
 * RulesAuthApi - object-oriented interface
 * @export
 * @class RulesAuthApi
 * @extends {BaseAPI}
 */
export class RulesAuthApi extends BaseAPI {
    /**
     * 
     * @summary Create an authentication rule
     * @param {string} organization Organization identifier
    ...
    public rulesAuthCreate(organization: string, project: string, v2RuleAuthRequest: V2RuleAuthRequest, options?: RawAxiosRequestConfig) {
        return RulesAuthApiFp(this.configuration).rulesAuthCreate(organization, project, v2RuleAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesAuthDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesAuthApiFp(this.configuration).rulesAuthDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesAuthList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesAuthApiFp(this.configuration).rulesAuthList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesAuthRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesAuthApiFp(this.configuration).rulesAuthRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesAuthUpdate(organization: string, project: string, rule: string, v2RuleAuthRequest: V2RuleAuthRequest, options?: RawAxiosRequestConfig) {
        return RulesAuthApiFp(this.configuration).rulesAuthUpdate(organization, project, rule, v2RuleAuthRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesBotChallengeApi - axios parameter creator
 * @export
 */
export const RulesBotChallengeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesBotChallengeApi - functional programming interface
 * @export
 */
export const RulesBotChallengeApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesBotChallengeApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a bot challenge rule
        ...
        async rulesBotChallengeCreate(organization: string, project: string, v2RuleBotChallengeRequest: V2RuleBotChallengeRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleBotChallenge>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesBotChallengeApi.rulesBotChallengeCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesBotChallengeDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesBotChallengeApi.rulesBotChallengeDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesBotChallengeList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleBotChallenge>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesBotChallengeApi.rulesBotChallengeList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesBotChallengeRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleBotChallenge>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesBotChallengeApi.rulesBotChallengeRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesBotChallengeUpdate(organization: string, project: string, rule: string, v2RuleBotChallengeRequest: V2RuleBotChallengeRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleBotChallenge>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesBotChallengeApi.rulesBotChallengeUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesBotChallengeApi - factory interface
 * @export
 */
export const RulesBotChallengeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesBotChallengeApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a bot challenge rule
...
/**
 * RulesBotChallengeApi - object-oriented interface
 * @export
 * @class RulesBotChallengeApi
 * @extends {BaseAPI}
 */
export class RulesBotChallengeApi extends BaseAPI {
    /**
     * 
     * @summary Create a bot challenge rule
     * @param {string} organization Organization identifier
    ...
    public rulesBotChallengeCreate(organization: string, project: string, v2RuleBotChallengeRequest: V2RuleBotChallengeRequest, options?: RawAxiosRequestConfig) {
        return RulesBotChallengeApiFp(this.configuration).rulesBotChallengeCreate(organization, project, v2RuleBotChallengeRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesBotChallengeDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesBotChallengeApiFp(this.configuration).rulesBotChallengeDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesBotChallengeList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesBotChallengeApiFp(this.configuration).rulesBotChallengeList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesBotChallengeRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesBotChallengeApiFp(this.configuration).rulesBotChallengeRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesBotChallengeUpdate(organization: string, project: string, rule: string, v2RuleBotChallengeRequest: V2RuleBotChallengeRequest, options?: RawAxiosRequestConfig) {
        return RulesBotChallengeApiFp(this.configuration).rulesBotChallengeUpdate(organization, project, rule, v2RuleBotChallengeRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesContentFilterApi - axios parameter creator
 * @export
 */
export const RulesContentFilterApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesContentFilterApi - functional programming interface
 * @export
 */
export const RulesContentFilterApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesContentFilterApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a content filter rule
        ...
        async rulesContentFilterCreate(organization: string, project: string, v2RuleContentFilterRequest: V2RuleContentFilterRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleContentFilter>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesContentFilterApi.rulesContentFilterCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesContentFilterDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesContentFilterApi.rulesContentFilterDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesContentFilterList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleContentFilter>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesContentFilterApi.rulesContentFilterList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesContentFilterRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleContentFilter>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesContentFilterApi.rulesContentFilterRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesContentFilterUpdate(organization: string, project: string, rule: string, v2RuleContentFilterRequest: V2RuleContentFilterRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleContentFilter>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesContentFilterApi.rulesContentFilterUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesContentFilterApi - factory interface
 * @export
 */
export const RulesContentFilterApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesContentFilterApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a content filter rule
...
/**
 * RulesContentFilterApi - object-oriented interface
 * @export
 * @class RulesContentFilterApi
 * @extends {BaseAPI}
 */
export class RulesContentFilterApi extends BaseAPI {
    /**
     * 
     * @summary Create a content filter rule
     * @param {string} organization Organization identifier
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof RulesContentFilterApi
     */
    public rulesContentFilterCreate(organization: string, project: string, v2RuleContentFilterRequest: V2RuleContentFilterRequest, options?: RawAxiosRequestConfig) {
        return RulesContentFilterApiFp(this.configuration).rulesContentFilterCreate(organization, project, v2RuleContentFilterRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesContentFilterDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesContentFilterApiFp(this.configuration).rulesContentFilterDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesContentFilterList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesContentFilterApiFp(this.configuration).rulesContentFilterList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesContentFilterRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesContentFilterApiFp(this.configuration).rulesContentFilterRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesContentFilterUpdate(organization: string, project: string, rule: string, v2RuleContentFilterRequest: V2RuleContentFilterRequest, options?: RawAxiosRequestConfig) {
        return RulesContentFilterApiFp(this.configuration).rulesContentFilterUpdate(organization, project, rule, v2RuleContentFilterRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesCustomResponseApi - axios parameter creator
 * @export
 */
export const RulesCustomResponseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesCustomResponseApi - functional programming interface
 * @export
 */
export const RulesCustomResponseApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesCustomResponseApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a custom response rule
        ...
        async rulesCustomResponseCreate(organization: string, project: string, v2RuleCustomResponseRequest: V2RuleCustomResponseRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleCustomResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesCustomResponseApi.rulesCustomResponseCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesCustomResponseDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesCustomResponseApi.rulesCustomResponseDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesCustomResponseList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleCustomResponse>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesCustomResponseApi.rulesCustomResponseList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesCustomResponseRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleCustomResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesCustomResponseApi.rulesCustomResponseRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesCustomResponseUpdate(organization: string, project: string, rule: string, v2RuleCustomResponseRequest: V2RuleCustomResponseRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleCustomResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesCustomResponseApi.rulesCustomResponseUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesCustomResponseApi - factory interface
 * @export
 */
export const RulesCustomResponseApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesCustomResponseApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a custom response rule
...
/**
 * RulesCustomResponseApi - object-oriented interface
 * @export
 * @class RulesCustomResponseApi
 * @extends {BaseAPI}
 */
export class RulesCustomResponseApi extends BaseAPI {
    /**
     * 
     * @summary Create a custom response rule
     * @param {string} organization Organization identifier
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof RulesCustomResponseApi
     */
    public rulesCustomResponseCreate(organization: string, project: string, v2RuleCustomResponseRequest: V2RuleCustomResponseRequest, options?: RawAxiosRequestConfig) {
        return RulesCustomResponseApiFp(this.configuration).rulesCustomResponseCreate(organization, project, v2RuleCustomResponseRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesCustomResponseDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesCustomResponseApiFp(this.configuration).rulesCustomResponseDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesCustomResponseList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesCustomResponseApiFp(this.configuration).rulesCustomResponseList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesCustomResponseRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesCustomResponseApiFp(this.configuration).rulesCustomResponseRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesCustomResponseUpdate(organization: string, project: string, rule: string, v2RuleCustomResponseRequest: V2RuleCustomResponseRequest, options?: RawAxiosRequestConfig) {
        return RulesCustomResponseApiFp(this.configuration).rulesCustomResponseUpdate(organization, project, rule, v2RuleCustomResponseRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesFunctionApi - axios parameter creator
 * @export
 */
export const RulesFunctionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesFunctionApi - functional programming interface
 * @export
 */
export const RulesFunctionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesFunctionApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create an edge function rule
        ...
        async rulesFunctionCreate(organization: string, project: string, v2RuleFunctionRequest: V2RuleFunctionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleFunction>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesFunctionApi.rulesFunctionCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesFunctionDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesFunctionApi.rulesFunctionDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesFunctionList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleFunction>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesFunctionApi.rulesFunctionList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesFunctionRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleFunction>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesFunctionApi.rulesFunctionRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesFunctionUpdate(organization: string, project: string, rule: string, v2RuleFunctionRequest: V2RuleFunctionRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleFunction>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesFunctionApi.rulesFunctionUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesFunctionApi - factory interface
 * @export
 */
export const RulesFunctionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesFunctionApiFp(configuration)
    return {
        /**
         * 
         * @summary Create an edge function rule
...
/**
 * RulesFunctionApi - object-oriented interface
 * @export
 * @class RulesFunctionApi
 * @extends {BaseAPI}
 */
export class RulesFunctionApi extends BaseAPI {
    /**
     * 
     * @summary Create an edge function rule
     * @param {string} organization Organization identifier
    ...
    public rulesFunctionCreate(organization: string, project: string, v2RuleFunctionRequest: V2RuleFunctionRequest, options?: RawAxiosRequestConfig) {
        return RulesFunctionApiFp(this.configuration).rulesFunctionCreate(organization, project, v2RuleFunctionRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesFunctionDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesFunctionApiFp(this.configuration).rulesFunctionDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesFunctionList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesFunctionApiFp(this.configuration).rulesFunctionList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesFunctionRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesFunctionApiFp(this.configuration).rulesFunctionRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesFunctionUpdate(organization: string, project: string, rule: string, v2RuleFunctionRequest: V2RuleFunctionRequest, options?: RawAxiosRequestConfig) {
        return RulesFunctionApiFp(this.configuration).rulesFunctionUpdate(organization, project, rule, v2RuleFunctionRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesHeadersApi - axios parameter creator
 * @export
 */
export const RulesHeadersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesHeadersApi - functional programming interface
 * @export
 */
export const RulesHeadersApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesHeadersApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a header rule
        ...
        async rulesHeadersCreate(organization: string, project: string, v2RuleHeaderRequest: V2RuleHeaderRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleHeader>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesHeadersApi.rulesHeadersCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesHeadersDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesHeadersApi.rulesHeadersDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesHeadersList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleHeader>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesHeadersApi.rulesHeadersList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesHeadersRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleHeader>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesHeadersApi.rulesHeadersRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesHeadersUpdate(organization: string, project: string, rule: string, v2RuleHeaderRequest: V2RuleHeaderRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleHeader>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesHeadersApi.rulesHeadersUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesHeadersApi - factory interface
 * @export
 */
export const RulesHeadersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesHeadersApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a header rule
...
/**
 * RulesHeadersApi - object-oriented interface
 * @export
 * @class RulesHeadersApi
 * @extends {BaseAPI}
 */
export class RulesHeadersApi extends BaseAPI {
    /**
     * 
     * @summary Create a header rule
     * @param {string} organization Organization identifier
    ...
    public rulesHeadersCreate(organization: string, project: string, v2RuleHeaderRequest: V2RuleHeaderRequest, options?: RawAxiosRequestConfig) {
        return RulesHeadersApiFp(this.configuration).rulesHeadersCreate(organization, project, v2RuleHeaderRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesHeadersDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesHeadersApiFp(this.configuration).rulesHeadersDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesHeadersList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesHeadersApiFp(this.configuration).rulesHeadersList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesHeadersRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesHeadersApiFp(this.configuration).rulesHeadersRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesHeadersUpdate(organization: string, project: string, rule: string, v2RuleHeaderRequest: V2RuleHeaderRequest, options?: RawAxiosRequestConfig) {
        return RulesHeadersApiFp(this.configuration).rulesHeadersUpdate(organization, project, rule, v2RuleHeaderRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesProxyApi - axios parameter creator
 * @export
 */
export const RulesProxyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesProxyApi - functional programming interface
 * @export
 */
export const RulesProxyApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesProxyApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a proxy rule
        ...
        async rulesProxyCreate(organization: string, project: string, v2RuleProxyRequest: V2RuleProxyRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleProxy>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesProxyApi.rulesProxyCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesProxyDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesProxyApi.rulesProxyDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesProxyList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleProxy>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesProxyApi.rulesProxyList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesProxyRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleProxy>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesProxyApi.rulesProxyRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesProxyUpdate(organization: string, project: string, rule: string, v2RuleProxyRequest: V2RuleProxyRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleProxy>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesProxyApi.rulesProxyUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesProxyApi - factory interface
 * @export
 */
export const RulesProxyApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesProxyApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a proxy rule
...
/**
 * RulesProxyApi - object-oriented interface
 * @export
 * @class RulesProxyApi
 * @extends {BaseAPI}
 */
export class RulesProxyApi extends BaseAPI {
    /**
     * 
     * @summary Create a proxy rule
     * @param {string} organization 
    ...
    public rulesProxyCreate(organization: string, project: string, v2RuleProxyRequest: V2RuleProxyRequest, options?: RawAxiosRequestConfig) {
        return RulesProxyApiFp(this.configuration).rulesProxyCreate(organization, project, v2RuleProxyRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesProxyDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesProxyApiFp(this.configuration).rulesProxyDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesProxyList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesProxyApiFp(this.configuration).rulesProxyList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesProxyRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesProxyApiFp(this.configuration).rulesProxyRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesProxyUpdate(organization: string, project: string, rule: string, v2RuleProxyRequest: V2RuleProxyRequest, options?: RawAxiosRequestConfig) {
        return RulesProxyApiFp(this.configuration).rulesProxyUpdate(organization, project, rule, v2RuleProxyRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesRedirectApi - axios parameter creator
 * @export
 */
export const RulesRedirectApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesRedirectApi - functional programming interface
 * @export
 */
export const RulesRedirectApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesRedirectApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a redirect rule
        ...
        async rulesRedirectCreate(organization: string, project: string, v2RuleRedirectRequest: V2RuleRedirectRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleRedirect>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesRedirectApi.rulesRedirectCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesRedirectDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesRedirectApi.rulesRedirectDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesRedirectList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleRedirect>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesRedirectApi.rulesRedirectList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesRedirectRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleRedirect>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesRedirectApi.rulesRedirectRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesRedirectUpdate(organization: string, project: string, rule: string, v2RuleRedirectRequest: V2RuleRedirectRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleRedirect>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesRedirectApi.rulesRedirectUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesRedirectApi - factory interface
 * @export
 */
export const RulesRedirectApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesRedirectApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a redirect rule
...
/**
 * RulesRedirectApi - object-oriented interface
 * @export
 * @class RulesRedirectApi
 * @extends {BaseAPI}
 */
export class RulesRedirectApi extends BaseAPI {
    /**
     * 
     * @summary Create a redirect rule
     * @param {string} organization 
    ...
    public rulesRedirectCreate(organization: string, project: string, v2RuleRedirectRequest: V2RuleRedirectRequest, options?: RawAxiosRequestConfig) {
        return RulesRedirectApiFp(this.configuration).rulesRedirectCreate(organization, project, v2RuleRedirectRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesRedirectDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesRedirectApiFp(this.configuration).rulesRedirectDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesRedirectList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesRedirectApiFp(this.configuration).rulesRedirectList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesRedirectRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesRedirectApiFp(this.configuration).rulesRedirectRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesRedirectUpdate(organization: string, project: string, rule: string, v2RuleRedirectRequest: V2RuleRedirectRequest, options?: RawAxiosRequestConfig) {
        return RulesRedirectApiFp(this.configuration).rulesRedirectUpdate(organization, project, rule, v2RuleRedirectRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * RulesServeStaticApi - axios parameter creator
 * @export
 */
export const RulesServeStaticApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * RulesServeStaticApi - functional programming interface
 * @export
 */
export const RulesServeStaticApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = RulesServeStaticApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Create a serve static rule
        ...
        async rulesServeStaticCreate(organization: string, project: string, v2RuleServeStaticRequest: V2RuleServeStaticRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleServeStatic>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesServeStaticApi.rulesServeStaticCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesServeStaticDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesServeStaticApi.rulesServeStaticDelete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesServeStaticList(organization: string, project: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<V2RuleServeStatic>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesServeStaticApi.rulesServeStaticList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesServeStaticRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleServeStatic>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesServeStaticApi.rulesServeStaticRead']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async rulesServeStaticUpdate(organization: string, project: string, rule: string, v2RuleServeStaticRequest: V2RuleServeStaticRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V2RuleServeStatic>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RulesServeStaticApi.rulesServeStaticUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * RulesServeStaticApi - factory interface
 * @export
 */
export const RulesServeStaticApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = RulesServeStaticApiFp(configuration)
    return {
        /**
         * 
         * @summary Create a serve static rule
...
/**
 * RulesServeStaticApi - object-oriented interface
 * @export
 * @class RulesServeStaticApi
 * @extends {BaseAPI}
 */
export class RulesServeStaticApi extends BaseAPI {
    /**
     * 
     * @summary Create a serve static rule
     * @param {string} organization Organization identifier
    ...
    public rulesServeStaticCreate(organization: string, project: string, v2RuleServeStaticRequest: V2RuleServeStaticRequest, options?: RawAxiosRequestConfig) {
        return RulesServeStaticApiFp(this.configuration).rulesServeStaticCreate(organization, project, v2RuleServeStaticRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesServeStaticDelete(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesServeStaticApiFp(this.configuration).rulesServeStaticDelete(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesServeStaticList(organization: string, project: string, options?: RawAxiosRequestConfig) {
        return RulesServeStaticApiFp(this.configuration).rulesServeStaticList(organization, project, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesServeStaticRead(organization: string, project: string, rule: string, options?: RawAxiosRequestConfig) {
        return RulesServeStaticApiFp(this.configuration).rulesServeStaticRead(organization, project, rule, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public rulesServeStaticUpdate(organization: string, project: string, rule: string, v2RuleServeStaticRequest: V2RuleServeStaticRequest, options?: RawAxiosRequestConfig) {
        return RulesServeStaticApiFp(this.configuration).rulesServeStaticUpdate(organization, project, rule, v2RuleServeStaticRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const SSHAccessApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getSshAccessCredentials: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/ssh-access`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ScalingPolicyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deleteScalingPolicy: async (organisation: string, application: string, environment: string, policyName: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/scaling-policies/{policyName}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
        ...
        getScalingPolicies: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/scaling-policies`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const V1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createSearchItem(createSearchItemRequest: CreateSearchItemRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1SearchMutationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createSearchItem(createSearchItemRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.createSearchItem']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async deleteSearchItem(project: number, objectId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1SearchMutationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteSearchItem(project, objectId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.deleteSearchItem']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async getSearchItem(project: number, objectId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSearchItem(project, objectId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.getSearchItem']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async getSearchItems(project: number, page?: number, hitsPerPage?: number, query?: string, filters?: GetSearchItemsFiltersParameter, facets?: GetSearchItemsFiltersParameter, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1SearchItemsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSearchItems(project, page, hitsPerPage, query, filters, facets, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.getSearchItems']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async getWafLogs(body?: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1WafLogListResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.getWafLogs']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieve content via API.
        ...
        async listFormSubmissions(quantUrl?: string, body?: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1FormSubmissionListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listFormSubmissions(quantUrl, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.listFormSubmissions']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieve proxies via API.
        ...
        async listProxies(body?: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ProxyListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listProxies(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.listProxies']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieve redirects via API.
        ...
        async testSearchExtractors(testSearchExtractorsRequest: TestSearchExtractorsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: object; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.testSearchExtractors(testSearchExtractorsRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.testSearchExtractors']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async updateSearchItem(updateSearchItemRequest: UpdateSearchItemRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1SearchMutationResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSearchItem(updateSearchItemRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['V1Api.updateSearchItem']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Upload a file via API.
...
export class V1Api extends BaseAPI {
     ...
     */
    public createSearchItem(createSearchItemRequest: CreateSearchItemRequest, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).createSearchItem(createSearchItemRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public deleteSearchItem(project: number, objectId: string, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).deleteSearchItem(project, objectId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public getSearchItem(project: number, objectId: string, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).getSearchItem(project, objectId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public getSearchItems(project: number, page?: number, hitsPerPage?: number, query?: string, filters?: GetSearchItemsFiltersParameter, facets?: GetSearchItemsFiltersParameter, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).getSearchItems(project, page, hitsPerPage, query, filters, facets, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getWafLogs(body?: object, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).getWafLogs(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public listFormSubmissions(quantUrl?: string, body?: object, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).listFormSubmissions(quantUrl, body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public listProxies(body?: object, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).listProxies(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public testSearchExtractors(testSearchExtractorsRequest: TestSearchExtractorsRequest, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).testSearchExtractors(testSearchExtractorsRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public updateSearchItem(updateSearchItemRequest: UpdateSearchItemRequest, options?: RawAxiosRequestConfig) {
        return V1ApiFp(this.configuration).updateSearchItem(updateSearchItemRequest, options).then((request) => request(this.axios, this.basePath));
    }
...
export const VariablesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deleteEnvironmentVariable: async (apiOrganisation: string, apiApplication: string, apiEnvironment: string, apiVariable: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{api_organisation}/applications/{api_application}/environments/{api_environment}/variables/{api_variable}`
...
export const VolumesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createVolume: async (organisation: string, application: string, environment: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/volumes`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        deleteVolume: async (organisation: string, application: string, environment: string, volume: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v3/organisations/{organisation}/applications/{application}/environments/{environment}/volumes/{volume}`
                .replace(`{${"organisation"}}`, encodeURIComponent(String(organisation)))
                .replace(`{${"application"}}`, encodeURIComponent(String(application)))
                .replace(`{${"environment"}}`, encodeURIComponent(String(environment)))
