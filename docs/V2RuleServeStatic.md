...
**action_config** | [**V2RuleServeStaticAction**](V2RuleServeStaticAction.md) |  | [default to undefined]

## Example

```typescript
import { V2RuleServeStatic } from '@quantcdn/quant-client';

const instance: V2RuleServeStatic = {
    message,
    error,
    name,
    uuid,
