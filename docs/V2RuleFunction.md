...
**action_config** | [**V2RuleFunctionAction**](V2RuleFunctionAction.md) |  | [default to undefined]

## Example

```typescript
import { V2RuleFunction } from '@quantcdn/quant-client';

const instance: V2RuleFunction = {
    message,
    error,
    name,
    uuid,
