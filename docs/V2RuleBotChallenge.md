...
**action_config** | [**V2RuleBotChallengeAction**](V2RuleBotChallengeAction.md) |  | [default to undefined]

## Example

```typescript
import { V2RuleBotChallenge } from '@quantcdn/quant-client';

const instance: V2RuleBotChallenge = {
    message,
    error,
    name,
    uuid,
