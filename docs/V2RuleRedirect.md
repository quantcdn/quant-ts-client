...
**action_config** | [**V2RuleRedirectAction**](V2RuleRedirectAction.md) |  | [optional] [default to undefined]

## Example

```typescript
import { V2RuleRedirect } from '@quantcdn/quant-client';

const instance: V2RuleRedirect = {
    message,
    error,
    name,
    uuid,
