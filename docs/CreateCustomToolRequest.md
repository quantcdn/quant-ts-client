...
**inputSchema** | **string** | JSON-encoded JSON Schema object defining the tool\&#39;s input parameters | [default to undefined]
...
**outputSchema** | **string** | JSON-encoded JSON Schema object defining the tool\&#39;s output structure | [optional] [default to undefined]
