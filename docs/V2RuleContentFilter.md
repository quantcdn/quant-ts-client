...
**notify** | **string** | Notification type | [optional] [default to undefined]
...
**action_config** | [**V2RuleContentFilterAction**](V2RuleContentFilterAction.md) |  | [default to undefined]

## Example

```typescript
import { V2RuleContentFilter } from '@quantcdn/quant-client';

const instance: V2RuleContentFilter = {
    message,
    error,
    name,
    uuid,
