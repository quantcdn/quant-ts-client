...
**action_config** | [**V2RuleErrorPageAction**](V2RuleErrorPageAction.md) |  | [default to undefined]

## Example

```typescript
import { V2RuleErrorPage } from '@quantcdn/quant-client';

const instance: V2RuleErrorPage = {
    name,
    uuid,
    rule_id,
    weight,
