...
|[**rulesErrorPageCreate**](#ruleserrorpagecreate) | **POST** /api/v2/organizations/{organization}/projects/{project}/rules/error-page | Create a custom error page rule|
|[**rulesErrorPageDelete**](#ruleserrorpagedelete) | **DELETE** /api/v2/organizations/{organization}/projects/{project}/rules/error-page/{rule} | Delete a custom error page rule|
|[**rulesErrorPageList**](#ruleserrorpagelist) | **GET** /api/v2/organizations/{organization}/projects/{project}/rules/error-page | List custom error page rules|
|[**rulesErrorPageRead**](#ruleserrorpageread) | **GET** /api/v2/organizations/{organization}/projects/{project}/rules/error-page/{rule} | Get details of a custom error page rule|
|[**rulesErrorPageUpdate**](#ruleserrorpageupdate) | **PATCH** /api/v2/organizations/{organization}/projects/{project}/rules/error-page/{rule} | Update a custom error page rule|
...
> V2RuleErrorPage rulesErrorPageCreate(v2RuleErrorPageRequest)
...
let organization: string; //Organization identifier (default to undefined)
let project: string; //Project identifier (default to undefined)
let v2RuleErrorPageRequest: V2RuleErrorPageRequest; //

const { status, data } = await apiInstance.rulesErrorPageCreate(
    organization,
    project,
    v2RuleErrorPageRequest
);
...
const { status, data } = await apiInstance.rulesErrorPageDelete(
    organization,
    project,
    rule
);
...
# **rulesErrorPageList**
> Array<V2RuleErrorPage> rulesErrorPageList()
...
const { status, data } = await apiInstance.rulesErrorPageList(
    organization,
    project
);
```
...
# **rulesErrorPageRead**
> V2RuleErrorPage rulesErrorPageRead()
...
const { status, data } = await apiInstance.rulesErrorPageRead(
    organization,
    project,
    rule
);
...
> V2RuleErrorPage rulesErrorPageUpdate(v2RuleErrorPageRequest)
...
const { status, data } = await apiInstance.rulesErrorPageUpdate(
    organization,
    project,
    rule,
    v2RuleErrorPageRequest
